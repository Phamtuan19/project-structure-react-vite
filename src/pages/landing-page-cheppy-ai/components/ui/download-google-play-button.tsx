   ...
   return (
      ...
      >
         ...
         >
            ...
            <span className="absolute inset-0 translate-x-[-150%] bg-gradient-to-r from-transparent via-white/20 to-transparent transition-transform duration-700 ease-in-out group-hover:translate-x-[150%]" />

            {/* Icon */}
            <ChplayIcon className="h-4 w-4 flex-shrink-0 text-white transition-transform duration-300 ease-out group-hover:scale-110 sm:h-5 sm:w-5 md:h-6 md:w-6" />

            {/* Text */}
            <div className="z-10 flex flex-col text-left leading-tight transition-transform duration-300 ease-out group-hover:-translate-y-[1px]">
